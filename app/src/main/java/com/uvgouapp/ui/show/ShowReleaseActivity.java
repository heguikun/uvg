...
import com.uvgouapp.contract.show.ShowReleasContract;
import com.uvgouapp.model.other.MessageEvent;
import com.uvgouapp.presenter.show.ShowReleasePresenter;
...
public class ShowReleaseActivity extends BaseActivity<ShowReleasePresenter> implements ShowReleasContract.View {
    ...
    protected int getLayoutId() {
        return R.layout.activity_release_show;
    }
    ...
    protected void initView() {
        ...
        mPresenter = new ShowReleasePresenter(this);
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_release://发布
                ...
                if (mChoiceList.size() > 0) {
                    mPresenter.sendShowDynamicState(content, mImageUrlList, address, userId);
                } else {
        ...
        public void onLocationChanged(AMapLocation amapLocation) {
            if (amapLocation != null) {
                if (amapLocation.getErrorCode() == 0) {
                    ...
                    mTvLocation.setText(String.format(Locale.ENGLISH, "%s%s%s", city, district, poiName));
