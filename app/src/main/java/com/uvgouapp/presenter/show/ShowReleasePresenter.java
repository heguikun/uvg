 ...
 * - @Description:  发布秀场
 */
public class ShowReleasePresenter extends BasePresenter<ShowReleasContract.View> implements ShowReleasContract.Presenter {

    private BaseActivity mBaseActivity;

    public ShowReleasePresenter(BaseActivity baseActivity) {
        this.mBaseActivity = baseActivity;
    }

    @Override
    public void sendShowDynamicState(String content, List<String> imgUrlList, String positionName, String userId) {
        ...
        if (verificationString(content, imgUrlList)) {
            ...
            OkGo.<String>post(Api.SHOW_RELEASE)
                    .upJson(jsonObject)
